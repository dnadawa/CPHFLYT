...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    var requestController =
        Provider.of<DriverAssignController>(context, listen: false);
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ToggleSwitch(
              initialLabelIndex: filterController.filter == Filter.Pending
                  ? 0
            ...
            if (filterController.filter == Filter.Trash)
              Button(
                  color: kDeclined,
                  text: "Empty Trash",
                  onPressed: () => requestController.emptyTrash(
                      navController.navItem, context)),
            if (filterController.filter == Filter.Trash)
              SizedBox(
                height: 30.h,
              ),
                    ...
                    child: Container(
                      ...
                      child: Center(
                          child: filterController.dateFilter == null
                              ...
                              : CustomText(
                                  text: filterController.dateFilter == null
                                      ? ""
                                      : DateFormat.MMMMd('da_DK').format(
                                              filterController
                                                  .dateFilter!.first) +
                                          ' - ' +
                                          DateFormat.MMMMd('da_DK').format(
                    ...
                    child: Container(
                      ...
                      child: DropdownButton(
                          ...
                          items: [
                            ...
                            DropdownMenuItem(
                              child: CustomText(text: 'Not Completed'),
                              value: CompletedFilter.NotCompleted,
                            ),
                            DropdownMenuItem(
                          ...
                          onChanged: (CompletedFilter? val) {
                            filterController.completedFilter =
                                val ?? CompletedFilter.All;
                          }),
                    ),
                  ),
              ],
                  ...
                  builder: (BuildContext context, snapshot) {
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          RequestModel request = databaseService
                              .createRequestFromJson(snapshot.data?[i]);
                                ...
                                children: [
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: CustomText(
                                                      text:
                                                          "Assigned Driver : ${snapshot.hasData ? snapshot.data!.data()!['name'].toString().split(' ')[0] : 'Loading...'}",
                                                      color: Colors.white,
                                                    ),
                                                  ),
                                                ),
                                  ...
                                  Container(
                                      ...
                                      child: Padding(
                                        padding: EdgeInsets.symmetric(
                                            horizontal: 5.w,
                                            vertical: filterController.filter ==
                                                    Filter.Approved
                                                ? 47.h
                                                : 35.h),
                                        child: Icon(
